...
import com.vctgo.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
     ...
     */
    @Override
    public IPage<SysConfig> selectConfigPage(SysConfig config)
    {
        ...
        return configMapper.selectConfigList(mpPage,config);
    }
